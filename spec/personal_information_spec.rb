...
describe 'PersonalInformation' do
    ...
    it "El metodo literal deberia devolver que le pasemos con un formato string" do
        personalInformation = PersonalInformation.new
        expect(personalInformation.literal(Time.parse('2019-05-16 15:40:36 -0400'))).to eq "16 Mayo 2019" 
    end
